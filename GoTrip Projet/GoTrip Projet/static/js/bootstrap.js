...
function afficher2(resaPays2){

    pays2 = document.getElementById('resaPays2');
    pays2.style.display = "block"
    ;

}

function cacher2(resaPays2){

    paye = document.getElementById('resaPays2');
    pays2.style.display = "none";


}

function afficher1(resaPays1){

    pays1 = document.getElementById('resaPays1');
    pays1.style.display = "block"
    ;

}

function cacher1(resaPays1){

    pays1 = document.getElementById('resaPays1');
    pays1.style.display = "none";


}


function afficherFait(resaFait){

    fait = document.getElementById('resaFait');
    fait.style.display = "block"
    ;

}

function cacherFait(resaFait){
...
function afficherChoix2(choix2){

    choix = document.getElementById('choix2');
    choix.style.display = "block"
    ;

}

function cacherChoix2(choix2){
...
window.onload = function () {
     ...
     document.getElementById("resaPays2").style.display = "none";
     document.getElementById("resaFait").style.display = "none";
     document.getElementById("durée2").style.display = "none";

};

function testPAYS(circuit){

    var nb = document.getElementById('id')

    if (resaPays1.value == resaPays2.value){
        alert("Les deux pays du circuit doivent être différents");
        return false  
...
function efface(tout){

    down = document.getElementById("choice");
    downFait = document.getElementById("nochoice");
    down.checked = false;
    downFait = false;

}

function afficherDurée2(durée2){

    duréeBIS = document.getElementById('durée2');
    duréeBIS.style.display = "block"
    ;

}

function cacherDurée2(durée2){

    duréeBIS = document.getElementById('durée2');
    duréeBIS.style.display = "none";


}

function afficherDurée1(durée1){

    durée = document.getElementById('durée1');
    durée.style.display = "block"
    ;

}

function cacherDurée1(durée1){

    durée = document.getElementById('durée2');
    durée.style.display = "none";
